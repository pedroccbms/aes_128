...
${OBJECTDIR}/_ext/42fdcd59/aes_128_key_expansion.o: ../../../Documentos/TCC2/AES-HARD/aes_128_key_expansion.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/42fdcd59/aes_128_key_expansion.o ../../../Documentos/TCC2/AES-HARD/aes_128_key_expansion.c

${OBJECTDIR}/_ext/42fdcd59/aes_128_teste.o: ../../../Documentos/TCC2/AES-HARD/aes_128_teste.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/42fdcd59
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/42fdcd59/aes_128_teste.o ../../../Documentos/TCC2/AES-HARD/aes_128_teste.c

${OBJECTDIR}/_ext/42fdcd59/aes_encrypt_decrypt.o: ../../../Documentos/TCC2/AES-HARD/aes_encrypt_decrypt.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/42fdcd59
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/42fdcd59/aes_encrypt_decrypt.o ../../../Documentos/TCC2/AES-HARD/aes_encrypt_decrypt.c
